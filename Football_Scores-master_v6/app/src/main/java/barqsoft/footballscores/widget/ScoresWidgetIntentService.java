...
public class ScoresWidgetIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        for (int appWidgetId : appWidgetIds) {
            ...
            views.setImageViewResource(R.id.home_crest, Utilies.getTeamCrestByTeamName(homeTeam, getApplicationContext()));
            views.setImageViewResource(R.id.away_crest, Utilies.getTeamCrestByTeamName(awayTeam, getApplicationContext()));
